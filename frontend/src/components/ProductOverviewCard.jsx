                        ...
                        ? (
                            user ? (
                                <button
                                    ...
                                    className='h-fit u-bg-tertiary shadow-[0px_4px_0px_rgba(0,0,0,0.3)] active:translate-y-[4px] active:shadow-[0px_0px_0px_rgba(0,0,0,0.3)] transition-all rounded-xl me-8 px-4 py-2 u-font-sarasvati text-sm u-text-white whitespace-nowrap'>
                                    Add to Cart
                                </button>
                            ) : (
                                <Link to={`/products/${product._id}`} className='h-fit u-bg-tertiary shadow-[0px_4px_0px_rgba(0,0,0,0.3)] active:translate-y-[4px] active:shadow-[0px_0px_0px_rgba(0,0,0,0.3)] transition-all rounded-xl me-8 px-4 py-2 u-font-sarasvati text-sm u-text-white whitespace-nowrap'>
                                    Show More
                                </Link>
                            )
                        ) : (
