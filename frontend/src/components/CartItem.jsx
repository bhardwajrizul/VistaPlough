		...
		<div className='p-4 u-box-shadow u-border-accent u-bg-white rounded-[25px] md:p-6'>
			<div className='space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0'>
				<div className='shrink-0 md:order-1'>
					<img className='h-20 md:h-32 rounded-[15px] u-border-accent object-cover' src={item.images[0]} />
				</div>
				...
				<div className='flex items-center justify-between md:order-3 md:justify-end'>
					<div className='flex items-center gap-2'>
						<button
							className='inline-flex h-7 w-7 shrink-0 items-center justify-center 
							 u-border-accent u-bg-tertiary hover:opacity-80 focus:outline-none focus:ring-2
						...
						<button
							className='inline-flex h-7 w-7 shrink-0 items-center justify-center
							 u-border-accent u-bg-tertiary hover:opacity-80 focus:outline-none 
					...
					<div className='text-end md:order-4 md:w-32'>
						<p className='u-font-itangiuh font-bold u-text-black'>${item.price}</p>
					</div>
				</div>
