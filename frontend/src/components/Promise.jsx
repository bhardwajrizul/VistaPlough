...
const Promise = () => {
    return (
        <div id='promise' className='mt-0 py-12 w-[85%] mx-auto min-h-lvh flex flex-col items-center justify-between gap-5'>
            ...
            <div id='promise-section' className=' overflow-hidden relative bg-white w-full h-fit rounded-[25px] u-border-accent py-10 flex flex-col items-center justify-between shadow-[0px_2px_4px_rgba(0,0,0,0.25)]'>
                <div id='cards-container' className='mb-10 w-[85%] rounded-[30px] grow flex flex-col justify-around gap-5'>
                    <div className='flex flex-row gap-5 justify-center items-stretch'>
                        <div id='card-1' className='u-bg-secondary rounded-[25px] flex-1 flex flex-col justify-center items-center gap-1 p-4 py-5 u-border-accent shadow-[0px_2px_0px_rgba(0,0,0,0.3)] hover:translate-y-[-2px] hover:shadow-[0px_4px_0px_rgba(0,0,0,0.3)] transition-all'>
                            <img src={Bee} alt="Pure and natural image" className='w-16' />
                            <h2 className='u-font-sarasvati font-bold underline text-3xl u-text-accent u-text-shadow'>
                                Pure and Natural
                            </h2>
                            <p className='u-font-itangiuh text-2xl px-3 text-center u-text-accent u-text-shadow'>
                    ...
                    <div className='flex flex-row gap-5 justify-center items-stretch'>
                        <div id='card-2' className='u-bg-secondary rounded-[25px] flex-1 flex flex-col justify-center items-center gap-1 p-4 py-5 u-border-accent shadow-[0px_2px_0px_rgba(0,0,0,0.3)] hover:translate-y-[-2px] hover:shadow-[0px_4px_0px_rgba(0,0,0,0.3)] transition-all'>
                            <img src={Flower} alt="Homemade Goodness Image" className='w-12' />
                            <h2 className='font-bold underline u-font-sarasvati text-3xl u-text-tertiary u-text-shadow'>
                                Homemade Goodness
                            </h2>
                            <p className='u-font-itangiuh text-2xl px-3 text-center u-text-tertiary u-text-shadow'>
                                Each item is lovingly prepared using <br></br> traditional methods to ensure authenticity.
                            </p>
                        </div>
                    </div>
                    <div className='flex flex-row gap-5 justify-center items-stretch'>
                        <div id='card-3' className='u-bg-secondary rounded-[25px] flex-1 flex flex-col justify-center items-center gap-1 p-4 py-5 u-border-accent shadow-[0px_2px_0px_rgba(0,0,0,0.3)] hover:translate-y-[-2px] hover:shadow-[0px_4px_0px_rgba(0,0,0,0.3)] transition-all'>
                            <img src={Heart} alt="Healthy and Delicious Image" className='w-12' />
                            <h2 className='font-bold underline u-font-sarasvati text-3xl u-text-primary u-text-shadow'>
                                Healthy and Delicious
                            </h2>
                            <p className='u-font-itangiuh  text-2xl px-3 text-center u-text-primary u-text-shadow'>
                                Packed with nutrients and flavor. <br></br> Our product is perfect for every household.
                            </p>
                        </div>
                    </div>
                </div>
                <div id='heading-with-btn' className='w-[85%] h-20 u-bg-secondary rounded-[25px] flex flex-row justify-around u-border-accent items-center gap-5 px-6 py-12 shadow-[0px_2px_0px_rgba(0,0,0,0.3)]'>
