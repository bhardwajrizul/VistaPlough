    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="flex flex-row lg:flex-col h-full gap-4 basis-[35%] lg:min-h-96 rounded-[25px] p-4">

                <Link
                    to="/profile"
                    className={`u-bg-tertiary text-center lg:mt-4 shadow-[0px_4px_0px_rgba(0,0,0,0.3)] active:translate-y-[4px] active:shadow-[0px_0px_0px_rgba(0,0,0,0.3)] transition-all rounded-xl py-3 u-font-sarasvati text-md lg:text-lg u-text-white hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-offset-2
                ...
                <Link
                    to={'/profile/orders'}
                    className={`u-bg-tertiary text-center lg:mt-1 shadow-[0px_4px_0px_rgba(0,0,0,0.3)] active:translate-y-[4px] active:shadow-[0px_0px_0px_rgba(0,0,0,0.3)] transition-all rounded-xl py-3 u-font-sarasvati text-lg u-text-white hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-offset-2
