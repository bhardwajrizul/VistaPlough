			...
			>
				<div className='u-bg-white u-box-shadow u-border-accent py-8 px-4 rounded-[25px] sm:px-10'>
					<form onSubmit={handleSubmit} className='space-y-6'>
						...
						<button
							type='submit'
							className='u-bg-tertiary shadow-[0px_4px_0px_rgba(0,0,0,0.3)] active:translate-y-[4px] active:shadow-[0px_0px_0px_rgba(0,0,0,0.3)] transition-all rounded-xl px-8 py-2 u-font-sarasvati text-2xl u-text-white w-full flex justify-center py-2 px-4
